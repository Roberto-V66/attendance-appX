<script lang="ts">
  ...
  function togglePresence(personId) {
    people = people.map((person) =>
      person.id === personId ? { ...person, present: !person.present } : person,
    );
  }
  ...
  <main class="flex flex-1 flex-col gap-4 p-4 md:gap-8 md:p-8">
              ...
              <Card.Root class="hover:shadow-lg transition-shadow duration-200">
                ...
                <Card.Footer class="flex justify-between">
                  ...
                  <Button
                    ...
                    on:click={() => togglePresence(person.id)}
                  >
    ...
    <div class="grid gap-4 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
      <Card.Root class="w-full">
        ...
        >
          <Card.Title class="text-sm font-medium">Total Poeple</Card.Title>
        </Card.Header>
        <Card.Content>
      ...
      <Card.Root class="w-full">
        <Card.Header
          class="flex flex-row items-center justify-between space-y-0 pb-2"
        >
          <Card.Title class="text-sm font-medium">Poeple Present</Card.Title>
        </Card.Header>
        <Card.Content>
      ...
      <Card.Root class="w-full">
        <Card.Header
          class="flex flex-row items-center justify-between space-y-0 pb-2"
        >
          <Card.Title class="text-sm font-medium">New poeple</Card.Title>
        </Card.Header>
        <Card.Content>
